...
import ru.ilyasekunov.auth.login.emailErrorMessage
import ru.ilyasekunov.auth.login.passwordErrorMessage
...
private fun RegistrationMainScreenContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = stringResource(featureAuthStrings.feature_auth_registration),
            ...
            RegistrationPasswordTextField(
                ...
                onPasswordValueChange = onPasswordValueChange,
                passwordPlaceholder = stringResource(featureAuthStrings.feature_auth_password),
            ...
            RegistrationPasswordTextField(
                ...
                passwordPlaceholder = stringResource(featureAuthStrings.feature_auth_repeat_password),
...
private fun RegistrationPasswordTextField(
    ...
    val passwordErrorMessage = if (passwordsDiffer) {
        stringResource(featureAuthStrings.feature_auth_repeated_password_error_differ_from_password)
    } else {
...
private fun LoginSection(
    ...
    Row(
        ...
        Text(
            text = stringResource(featureAuthStrings.feature_auth_have_account),
